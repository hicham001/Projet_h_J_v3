<div class="row">
 ...
 <div class="row">
            <div class="form-group col-md-12">
                ...
                <h4>{{ctrl.evaluateur.matricule}}</h4>
            </div>
        </div>
