<div class="row">
           <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
           <!--  <div class="x_title"><h2>Ajouter un nouveau Evaluateur</h2>
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <input type="text"  ng-model="ctrl.evaluateur.matricule" class="form-control input-sm"/>
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="lastName">Prénom</label>
                <div class="col-md-7">
                    ...
                    <div class="ln_solid"></div>
                                        <div class="form-group">
                                            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-8">                                            
                                                <button ng-click="ctrl.ajouter()" class="btn btn-success" >Ajouter</button>
