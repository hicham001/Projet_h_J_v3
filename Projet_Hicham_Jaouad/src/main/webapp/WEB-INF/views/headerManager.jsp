                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                       ...
                       <h3>${param.role}</h3>
                            <ul class="nav side-menu"><br><br>
                                ...
                                <li><a><i class="fa fa-edit"></i> Sujets BAPs <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="./GestionProjet#/CreateProjetEvaluateur">Nouveau Sujet</a>
                                        </li>
                                        <li><a href="./GestionProjet#/AffecterObjectEval">Affecter des Objectifs</a>
                                        </li>
                                        
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-line-chart"></i> Résultats & Feedback </a>
