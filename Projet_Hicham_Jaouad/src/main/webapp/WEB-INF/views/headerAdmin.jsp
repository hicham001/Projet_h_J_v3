                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile">
                        <div class="profile_pic">
                            <img src="<%=request.getContextPath()%>/static/images/admin.jpg" alt="..." class="img-circle profile_img">
                        </div>
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-edit"></i> Utilisateur <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="./GestionCollaborateur">Collaborateur</a>
                                        </li>
                                        <li><a href="./GestionManager">Manager RH</a>
                                        </li>
                                        <li><a href="./GestionEvaluateur">Evaluateur</a>
                                        </li>
                                        
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-bell-o"></i> Déclenchement BAP <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="./notifier">Notification</a>
                                        </li>
										<li><a href="./sujets">Sujets</a>
                                        </li>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <img src="<%=request.getContextPath()%>/static/images/admin.jpg" alt="">${param.nom}
                            ...
                            <li role="presentation" class="dropdown">
                                ...
                                <ul id="menu1" class="dropdown-menu list-unstyled msg_list animated fadeInDown" role="menu">
                                    <li>
                                        <a>
                                            <span class="image">
                                        <img src="<%=request.getContextPath()%>/static/images/admin.jpg" alt="Profile Image" />
                                    </span>
                                            <span>
