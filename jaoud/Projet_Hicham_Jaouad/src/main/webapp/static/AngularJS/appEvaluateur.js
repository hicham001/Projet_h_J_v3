...
var GestionEvaluateur = angular.module('GestionEvaluateur',['ngRoute']).config(['$routeProvider', function ($routeProvider) {
    $routeProvider.when('/GestionEvaluateur', {templateUrl: 'static/AngularJS/Templates/Evaluateur/liste-evaluateurs.jsp', controller: 'EvaluateurController'})
    ...
    .otherwise({redirectTo: '/GestionEvaluateur'});
}]);
