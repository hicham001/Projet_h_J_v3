  <div class="row">
           <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel"> 
            <div class="x_title">
            <div class="col-md-6"><h2>Ajouter Nouveau Collaborateur</h2></div>  
                    ...
                    <div class="ln_solid"></div>
                                        <div class="form-group">
                                            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-8">                                            
                                                <a ng-click="ctrl.ajouter()" class="btn btn-success" >Ajouter</a>
                                                <a  ng-click="ctrl.cancel()" class="btn btn-primary">Annuler</a>
                                            </div>
                                        </div>
            </div>
        </div>
