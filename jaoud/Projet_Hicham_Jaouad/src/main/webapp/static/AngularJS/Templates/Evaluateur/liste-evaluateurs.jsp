            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr ng-repeat="evaluateur in ctrl.evaluateurs">
                           ...
                           <td><button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal" ng-click="ctrl.detailsEvaluateur(evaluateur)">Info</button><td>  
                        <td><a class="btn btn-success custom-width" data-toggle="modal" data-target="#myModal2" ng-click="ctrl.prepareEdit(evaluateur)">edit</a></td>
                        <td><a class="btn btn-danger custom-width" ng-click="ctrl.remove(evaluateur.matricule)" >delete</a></td>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" ng-click="ctrl.reset()"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Modifier Evaluateur</h4>
      </div>
      <div class="modal-body">
       <ng-update></ng-update>
      </div>
