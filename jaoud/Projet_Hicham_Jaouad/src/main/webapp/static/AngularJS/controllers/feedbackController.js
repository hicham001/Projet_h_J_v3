...
GestionFeedback.controller('feedbackController', ['$scope','$rootScope', 'feedbackService','$location',function($scope,$rootScope,feedbackService,$location) {
	...
	$scope.productivite={theme:"productivité",valeur :"",remarque:"",feedback :{idFeedback:null}};
	$scope.qualite={theme:"Qualité/Fiabilité",valeur :"",remarque:"",feedback :{idFeedback:null}};
	$scope.technicite = {theme:"Technicité",valeur :"",remarque:"",feedback :{idFeedback:null}};
	$scope.conception = {theme:"Conception",valeur :"",remarque:"",feedback :{idFeedback:null}};
	...
	$scope.qualifications =[$scope.productivite,$scope.qualite,$scope.technicite,$scope.conception,$scope.avantVente,$scope.gestionProjet,$scope.gestionRClient,$scope.polyvalence];
